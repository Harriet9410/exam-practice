var QUESTIONS = [
  {
    ...
    "type": "qa",
    "answer": "æºæä»¶æ©å±åä¸º .javaï¼ç¼è¯çæå­èç æä»¶æ©å±åä¸º .class",
    "options": [],
    "subject": "Java",
    "category": "é®ç­é¢",
    "question": "æºæä»¶æ©å±åä¸º?ç¼è¯çæå­èç æä»¶æ©å±åä¸º?",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "type": "qa",
    "answer": "è¡æ³¨éï¼//ï¼åæ³¨éï¼/* ... */ï¼ææ¡£æ³¨éï¼/** ... */",
    "options": [],
    "subject": "Java",
    "category": "é®ç­é¢",
    "question": "è¡æ³¨éãåæ³¨éãææ¡£æ³¨éåå«æä¹æ æ³¨?",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "type": "qa",
    "answer": "ç¼è¯æºä»£ç ï¼javac æºæä»¶å.java è¿è¡å­èç ï¼java ç±»å æ¾ç¤ºJDKçæ¬å·ï¼java -version åç¼è¯å­èç ï¼javap ç±»å çæææ¡£æ³¨éï¼javadoc æºæä»¶å.java",
    "options": [],
    "subject": "Java",
    "category": "é®ç­é¢",
    "question": "ç¼è¯æºä»£ç å½ä»¤ãè¿è¡å­èç ãæ¾ç¤ºJDKçæ¬å·ãåç¼è¯å­èç ãçæææ¡£æ³¨éçå½ä»¤åæ ¼å¼",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "type": "qa",
    "answer": "å¸å°ååéå®ä¹ï¼boolean flag = true; æ boolean flag = false;ï¼åå¼åªè½æ¯ true æ false",
    "options": [],
    "subject": "Java",
    "category": "é®ç­é¢",
    "question": "å¸å°ååéå®ä¹å®ä¹ååå¼",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "type": "qa",
    "answer": "é¢åå¯¹è±¡ä¸ä¸ªç¹æ§ï¼å°è£ï¿½ï¿½ç»§æ¿ãå¤æ",
    "options": [],
    "subject": "Java",
    "category": "é®ç­é¢",
    "question": "é¢åå¯¹è±¡ä¸ä¸ªç¹æ§",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "type": "qa",
    "answer": "staticï¼éææåï¼å±äºç±»èéå®ä¾ classï¼å®ä¹ç±» implementsï¼å®ç°æ¥å£ interfaceï¼ï¿½ï¿½ï¿½ä¹æ¥å£ thisï¼å½åå¯¹è±¡å¼ç¨ superï¼ç¶ç±»å¼ç¨ importï¼å¯¼å¥å/ç±» packageï¼å£°æå abstractï¼æ½è±¡ç±»/æ½è±¡æ¹æ³ finalï¼ç±»ä¸å¯ç»§æ¿ãæ¹æ³ä¸å¯éåãåéä¸ºå¸¸é",
    "options": [],
    "subject": "Java",
    "category": "é®ç­é¢",
    "question": "static class implements interface this super import package abstract finalå³é®å­ç¨é",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "type": "qa",
    "answer": "ç±»æåè®¿é®æéæ§å¶å³é®å­ï¼privateï¼æ¬ç±»ï¼ãdefault/ç¼ºçï¼ååï¼ãprotectedï¼åå+å­ç±»ï¼ãpublicï¼ä»»æï¼",
    "options": [],
    "subject": "Java",
    "category": "é®ç­é¢",
    "question": "ç±»æåè®¿é®æéæ§å¶å³é®å­",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "type": "qa",
    "answer": "å¤å±ç»§æ¿æé å½æ°æ§è¡è¿ç¨ï¼ä»æé¡¶å±ç¶ç±»å¼å§éå±åä¸æ§è¡ï¼åæ§è¡ Object æé ï¼åæ§è¡ä¸­é´ç¶ç±»æé ï¼æåæ§è¡å­ç±»æé ï¼å­ç±»æé é»è®¤é¦è¡è°ç¨ super()",
    "options": [],
    "subject": "Java",
    "category": "é®ç­é¢",
    "question": "å¤å±ç»§æ¿æé å½æ°æ§è¡è¿ç¨",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "type": "qa",
    "answer": "Lambdaè¡¨è¾¾å¼æåºï¼Arrays.sort(a, (o1, o2) -> o1 - o2) åååä¸ºååºï¼Arrays.sort(a, (o1, o2) -> o2 - o1) åååä¸ºéåº",
    "options": [],
    "subject": "Java",
    "category": "é®ç­é¢",
    "question": "å°æ³¢ï¿½ï¿½è¡¨è¾¾å¼å®ä¹æåºè§åä½¿ç¨ï¼å¦Arrays.sort(a,(01,02)->02-01),åé¢ååé¢ä¸ºååºï¼åé¢ååé¢ä¸ºéåº",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "type": "qa",
    "answer": "å¼å¸¸å¤çå³é®å­ï¼tryãcatchãfinallyãthrowãthrows",
    "options": [],
    "subject": "Java",
    "category": "é®ç­é¢",
    "question": "å¼å¸¸å¤çå³é®å­",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "type": "qa",
    "answer": "å¤çº¿ç¨ä¸»è¦æ¹æ³ï¼ sleep() ä¼ç æå®æ¯«ç§ run() çº¿ç¨æ§è¡ä½ start() å¯å¨çº¿ç¨ interrupt() ä¸­æ­çº¿ç¨ wait() éæ¾éç­å¾ notify() å¤éä¸ä¸ªç­å¾çº¿ç¨ notifyAll() å¤éææç­å¾çº¿ç¨",
    "options": [],
    "subject": "Java",
    "category": "é®ç­é¢",
    "question": "å¤çº¿ç¨ä¸»è¦æ¹æ³ååè½å¦sleep run start interrupt wait notify notifyAllç­",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "type": "qa",
    "answer": "æ³åå®¹å¨ç±»ï¼ ArrayList å¨ææ°ç» LinkedList ååé¾è¡¨ HashSet æ åºä¸éå¤ TreeSet æåºä¸éå¤ HashMap é®å¼å¯¹æ åº TreeMap é®å¼å¯¹æåº BigInteger å¤§æ´æ° ç»ä¸ä½¿ç¨æ³åæ ¼å¼å¦ ArrayList<String> list = new ArrayList<>()",
    "options": [],
    "subject": "Java",
    "category": "é®ç­é¢",
    "question": "æ³åå®¹å¨ç±»ãæ¿æ¥å°±ç¨çº¿ç¨çä½¿ç¨æ ¼å¼ç»ä¸çæ¹æ³ï¼æ¯ææ³åï¼TreeSet HashSet TreeMap HashMap LinkedList ArrayList BigInteger",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "type": "qa",
    "answer": "æä»¶å­èæµï¼FileInputStream/FileOutputStream å­ç¬¦æµï¼FileReader/FileWriter ç¼å²æµï¼BufferedReader/BufferedWriterãBufferedInputStream/BufferedOutputStream æ°ç»æµï¼ByteArrayInputStream/ByteArrayOutputStream å­ç¬¦ä¸²æµï¼StringReader/StringWriter",
    "options": [],
    "subject": "Java",
    "category": "é®ç­é¢",
    "question": "æä»¶å­èæµãå­ç¬¦æµãç¼å²æµãæ°ç»æµãå­ç¬¦ä¸²æµ",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "type": "qa",
    "answer": "æä»¶åºååï¼ç±»å®ç° Serializable æ¥å£ï¼ç¨ ObjectOutputStream ç writeObject() åå¥ï¼ObjectInputStream ç readObject() è¯»åï¼å¯æ´ä½è¯»åå¯¹è±¡ãæ°ç»ãLinkedList",
    "options": [],
    "subject": "Java",
    "category": "é®ç­é¢",
    "question": "æä»¶åºååï¼æä¸ä¸ªå¯¹è±¡å®å¨è½¬æå­èåºåï¼ä¸ç¨èèå¯¹è±¡æåä¸ªæ°åç±»åï¼ä»¥æ´ä¸ªå¯¹è±¡ãæ°ç»ãLinkedListä¸ºåä½è¯»åæä»¶",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "type": "qa",
    "answer": "ä¸ºæé®ç­ç»ä»¶ç»å®çè§å¨ï¼button.addActionListener(listener);ï¼çå¬å¨å®ç° ActionListener æ¥å£ï¼éå actionPerformed(ActionEvent e) æ¹æ³",
    "options": [],
    "subject": "Java",
    "category": "é®ç­é¢",
    "question": "ä¸ºæé®ç­ç»ä»¶äºä»¶æºï¼ç»å®çè§å¨çå¬çæ¹æ³addActionListener",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "type": "qa",
    "answer": "(1)import java.util.Scanner; public class Exam{ public static void main(String argv[]){ Scanner sr=new Scanner(System.in); int i,s=0,a; for (i=1;i<=10;i++){ a=sr.nextInt(); s=s+a; } System.out.printf(\"%.2f\\n\",s/10.0); } } (2)import java.util.Scanner; public class Exam{ public static void main(String argv[]){ Scanner sr=new Scanner(System.in); double s=0,a; int gs=0; while(sr.hasNextDouble()){ a=sr.nextDouble(); s=s+a; gs++; } System.out.printf(\"%dä¸ªæ°çå¹³åå¼ä¸º%.2f\\n\",gs,s/gs); } }",
    "options": [],
    "subject": "Java",
    "category": "ç¼ç¨é¢",
    "question": "æ±å¹³åå¼",
  ...
  },
  {
    ...
    "type": "qa",
    "answer": "ï¼ç»§æ¿ï¼interface XS{ int getXS(); } class NX implements XS{ public int getXS(){ return 100000; } } class YX implements XS{ public int getXS(){ return 8000*12; } } class ZX implements XS{ public int getXS(){ return 1500*52; } } public class Exam { public static void main(String[] args) { XS s[]={new NX(),new YX(),new ZX()}; for(int i=0;i<=2;i++) System.out.println(s[i].getXS()); } } ï¼æ½è±¡ï¼abstract class XS{ abstract int getXS(); } class NX extends XS{ public int getXS(){ return 100000; } } class YX extends XS{ public int getXS(){ return 8000*12; } } class ZX extends XS{ public int getXS(){ return 1500*52; } } public class Exam { public static void main(String[] args) { XS s[]={new NX(),new YX(),new ZX()}; for(int i=0;i<=2;i++) System.out.println(s[i].getXS()); } }",
    "options": [],
    "subject": "Java",
    "category": "ç¼ç¨é¢",
    "question": "ç»§æ¿å¤æï¼æ½è±¡ç±»",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "å¤éé¢",
    "question": "é©¬åæä¸»ä¹ä¸­å½åæ¶ä»£åï¼å°±æ¯ç«è¶³ä¸­å½å½æåæ¶ä»£ç¹ç¹ï¼åææé©¬åæä¸»ä¹åºæ¬åçå    ç¸ç»åãå    ç¸ç»åï¼æ·±å¥ç ç©¶åè§£å³ä¸­å½é©å½ãå»ºè®¾ãæ¹é©ä¸ååå²æ¶æçå®éé®é¢ï¼çæ­£ææé¢ä¸´çæ¶ä»£è¯¾é¢ï¼åé æ°ççè®ºææã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "options": [
      "åæååå±ä»ä¹æ ·çä¸­å½ç¹è²ç¤¾ä¼ä¸»ä¹ãææ ·åæååå±ä¸­å½ç¹è²ç¤¾ä¼ä¸»ä¹",
      "å»ºè®¾ä»ä¹æ ·çç¤¾ä¼ä¸»ä¹ç°ä»£åå¼ºå½ãææ ·å»ºè®¾ç¤¾ä¼ä¸»ä¹ç°ä»£åå¼ºå½",
      "å»ºè®¾ä»ä¹æ ·çåãææ ·å»ºè®¾åï¼å®ç°ä»ä¹æ ·çåå±ãææ ·åå±",
      "å»ºè®¾ä»ä¹æ ·çé¿ææ§æ¿çé©¬åæä¸»ä¹æ¿åãææ ·å»ºè®¾é¿ææ§æ¿çé©¬åæä¸»ä¹æ¿å"
    ],
    "subject": "æ¯æ¦",
    "category": "å¤éé¢",
    "question": "åçåå«å¤§ä»¥æ¥ï¼ä¸­å½ç¹è²ç¤¾ä¼ä¸»ä¹è¿å¥æ°æ¶ä»£ï¼ä»¥ä¹ è¿å¹³åå¿ä¸ºä¸»è¦ï¿½ï¿½è¡¨çä¸­å½å±äº§åäººï¼æåºä¸ç³»åååæ§çæ²»å½çæ¿æ°çå¿µæ°ææ³æ°æç¥ï¼ä¸»è¦ç³»ç»åç­æ°æ¶ä»£åªäºéå¤§æ¶ä»£è¯¾é¢?",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "options": [
      ...
      "ä¹ è¿å¹³æ°æ¶ä»£ä¸­å½ï¿½ï¿½ï¿½è²ç¤¾ä¼ä¸»ä¹ææ³"
    ],
    "subject": "æ¯æ¦",
    "category": "å¤éé¢",
    "question": "å¨é©¬åæä¸»ä¹ä¸­å½åæ¶ä»£åçåå²è¿ç¨ä¸­ï¼äº§çäºæ¯æ³½ä¸ææ³ã( )ç­çè®ºææã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "options": [
      "åå²ä¸æ¾ç¯è¿ææ¡ä¸»ä¹ãç»éªä¸»ä¹éè¯¯",
      "é©¬åæä¸»ä¹çè®ºè§£å³äºä¿å½å®éé®é¢",
      "è§£å³ä¸­å½å®éé®é¢çå®¢è§éè¦",
      "é©¬åæä¸»ä¹çè®ºæ¬èº«åå±çåå¨è¦æ±"
    ],
    "subject": "æ¯æ¦",
    "category": "å¤éé¢",
    "question": "ä¸ºä»ä¹æ¨è¿é©¬åæä¸»ä¹ä¸­å½åæ¶ä»£åï¼æ¯æä»¥ä¸ä¸¤ä¸ªåå ï¼ä¸æ¯    ï¼äºæ¯     ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "options": [
      "æ¹é©å¼æ¾",
      "ä¸­å½ç¹è²ç¤¾ä¼ä¸»ä¹å»ºè®¾",
      "ç¤¾ä¼ä¸»ä¹é©å½",
      "æ°æ°ä¸»ä¸»ä¹é©å½"
    ],
    "subject": "æ¯æ¦",
    "category": "å¤éé¢",
    "question": "æ¯æ³½ä¸ææ³æ¢åæ¬å³äº( )çæ­£ç¡®ææ³ï¼ä¹åæ¬å³äºç¤¾ä¼ä¸»ä¹å»ºè®¾çæ­£ç¡®ææ³ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "å¤éé¢",
    "question": "ï¿½ï¿½ï¿½å­¦çè¦åæçè®ºèç³»å®éï¼ç´§å¯èç³»( )ãä¸­åæ°æåå±å²ï¼ç´§å¯èç³»èªå·±çææ³å®éï¼æçè®ºä¸å®è·µãçæ³ä¸ç°å®ãä¸»è§ä¸å®¢ï¿½ï¿½ï¿½ãç¥ä¸è¡ææºç»ä¸èµ·æ¥ï¼èªè§æèº«äºä¸­å½ç¹è²ç¤¾ä¼ä¸»ä¹ä¼å¤§å®è·µï¼ä¸ºå®ç°ä¸­åæ°æä¼å¤§å¤å´ä½åºåºæè´¡ç®ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "å¤éé¢",
    "question": "å¤§å­¦çè¦åæçè®ºèç³»å®éï¼ç´§å¯ç»å( )çä¼å¤§å®è·µï¼èªè§æèº«äºä¸­å½ç¹è²ç¤¾ä¼ä¸»ä¹ä¼å¤§å®è·µï¼ä¸ºå®ç°ä¸­åæ°æä¼å¤§å¤å´ä½åºåºæè´¡ç®ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "å¤éé¢",
    "question": "æä»¬è¦åå®ä¸­å½ç¹è²ç¤¾ä¼ä¸»ä¹( )ï¼å¢è¿æ¿æ²»è®¤åãææ³è®¤åãææè®¤åã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "options": [
      "ä¹ è¿å¹³æ°æ¶ä»£ä¸­å½ç¹è²ç¤¾ä¼ä¸»ä¹ææ³",
      "é©¬åæåå®ä¸»ï¿½ï¿½",
    ...
    "subject": "æ¯æ¦",
    "category": "å¤éé¢",
    "question": "ä¸­å½å±äº§åä»¥    ãæ¯æ³½ä¸ææ³ãéå°ï¿½ï¿½çè®ºãâä¸ä¸ªä»£è¡¨âéè¦ææ³ãç§å­¦åå±è§ã    ä½ä¸ºèªå·±çæå¯¼ææ³åè¡å¨æåã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "å¤éé¢",
    "question": "( )æ¯æ¯æ³½ä¸ææ³æ´»ççµé­ï¼è¿ä¸å·æä¸­å½å±äº§åäººç¹è²çç«åºãè§ç¹åæ¹æ³ä¹è´¯ç©¿äºä¸­å½ç¹è²ç¤¾ä¼ä¸»ä¹çè®ºä½ç³»ä¹ä¸­ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "å¤éé¢",
    "question": "å¨æ°æ°ä¸»ä¸»ä¹é©å½æ¶æï¼ä»¥æ¯æ³½ä¸åå¿ä¸ºä¸»è¦ä»£è¡¨çä¸­å½å±äº§åäººï¼æé©¬åæåå®ä¸»ä¹åºæ¬åçåä¸­å½å·ä½å®éç»åèµ·æ¥ï¼å¯¹ç»è¿è°è¦æ¢ç´¢ãä»åºå·¨å¤§çºç²ç§¯ç´¯çä¸ç³»åç¬åæ§ç»éªä½äºçè®ºæ¦æ¬ï¼å¼è¾äº( )çæ­£ç¡®é©å½éè·¯ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "å¤éé¢",
    "question": "åæååå±é©¬åæä¸»ä¹ï¼å¿é¡»åä¸­å½å·ä½å®éç¸ç»åï¼çç¼è§£å³é©å½ãå»ºè®¾ãæ¹é©ä¸­çå®éé®é¢ï¼ä¸æ­åç­( )ï¼ä½åºç¬¦åä¸­å½ï¿½ï¿½éåæ¶ä»£è¦æ±çæ­£ç¡®åç­ï¼å¾åºç¬¦åå®¢è§è§å¾çç§å­¦è®¤è¯ï¼å½¢æä¸æ¶ä¿±è¿ççè®ºææï¼æ´å¥½æå¯¼ä¸­å½å®è·µã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "å¤éé¢",
    "question": "åç¡®ææ¡é©¬åæä¸»ä¹ä¸­å½åæ¶ä»£åçç§å­¦åæ¶µï¼è¦å    ä¸    ç¸ç»ä¸ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "options": [
      "å®ç°äºä»çäº§åç¸å¯¹è½åçç¶åµå°ç»æµæ»éè·å±ä¸çç¬¬äºçåå²æ§çªç ´",
      "å®ç°äºäººæ°çæ´»ä»æ¸©é¥±ä¸è¶³å°æ»ä½å°åº·ãå¥åå¨é¢å°åº·çåå²æ§è·¨è¶",
      "ä¸ºå®ç°ä¸­åæ°æä¼å¤§å¤å´æä¾äºåæ»¡æ°çæ´»åçä½å¶ä¿è¯åå¿«éåå±çç©è´¨æ¡ä»¶",
      "æ¨è¿äºä¸­åæ°æä»ç«èµ·æ¥å°å¯èµ·æ¥çä¼å¤§é£è·"
    ],
    "subject": "æ¯æ¦",
    "category": "å¤éé¢",
    "question": "ä¸­å½å±äº§åé«ä¸¾ä¸­å½ç¹è²ç¤¾ä¼ä¸»ä¹ä¼å¤§æå¸ï¼å¢ç»å¸¦é¢ä¸­å½äººæ°ï¼è§£æ¾ææ³ãéæè¿åï¼åé äºæ¹é©å¼æ¾åç¤¾ä¼ä¸»ä¹ç°ä»£åå»ºè®¾çä¼å¤§æå°±ï¼æå½",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "å¤éé¢",
    "question": "ï¿½ï¿½ï¿½æé©¬åæä¸»ä¹ï¼æéè¦çæ¯åæé©¬åæä¸»ä¹åºæ¬åçåè´¯ç©¿å¶ä¸­ç( )ï¼åå®ä¸ç§»åæé©¬åæä¸»ä¹æå¯¼å°ä½ï¼ä»»ä½æ¶ï¿½ï¿½ï¿½ä»»ä½æåµä¸é½ä¸å¨æã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "åéé¢",
    "question": "( )ç»ä¸­å½éæ¥äºé©¬åæåå®ä¸»ä¹ï¼ç»è¦è¦æ¢å¯»æäº¡å¾å­åºè·¯çä¸­å½äººæ°ææäºåè¿æ¹åãæä¾äºå¨æ°éæ©ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "åéé¢",
    "question": "ä¸­å½å±äº§åä»æç«ä¹æ¥èµ·ï¼å°±æç¡®æ( )ç¡®ç«ä¸ºæå¯¼ææ³ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "åéé¢",
    "question": "1945å¹´ï¼å¨åçä¸å¤§ä¸ï¼( )ä»£è¡¨åä¸­å¤®ä½äºãå³äºä¿®æ¹åç« çæ¥åãï¼å¯¹é©¬åæä¸»ä¹ä¸­å½åä»çè®ºï¿½ï¿½ä½äºè¿ä¸æ­¥çéè¿°ï¼å¹¶æåºæ¯æ³½ä¸ææ³æ¯âä¸­å½åçé©¬åæä¸»ä¹âã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "åéé¢",
    "question": "1938å¹´ï¼æ¯æ³½ä¸å¨åçå­å±å­ä¸­å¨ä¼ä¸ä½äºãè®ºæ°é¶æ®µãçæ¥åï¼å¼ºè°:âæ²¡ææ½è±¡çé©¬åæä¸»ä¹ï¼åªæå·ä½çé©¬åæä¸»ä¹ãâ¦â¦é©¬åæä¸»ä¹çä¸­å½åï¼ä½¿ä¹å¨å¶æ¯ä¸è¡¨ç°ä¸­å¸¦çä¸­å½çç¹æ§ï¼å³æ¯è¯´ï¼æç§ä¸­å½çç¹ç¹å»åºç¨å®ï¼æä¸ºå¨åäºå¾äºè§£å¹¶äºé¡»è§£å³çé®é¢ãâè¿æ å¿ç( )è¿ä¸å½é¢çæ­£å¼æåºã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "åéé¢",
    "question": "åçåå«å¤§ä»¥æ¥ï¼ä»¥ä¹ è¿å¹³åå¿ä¸ºæ ¸å¿çåä¸­å¤®æç¡®æåºè¦ä¸æ­æ¨è¿( )ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "åéé¢",
    "question": "2021å¹´ï¼åç( )éè¿çãä¸­å±ä¸­å¤®å³äºåçç¾å¹´å¥æéå¤§ï¿½ï¿½ï¿½å°±ååå²ç»éªçå³è®®ãæ»ç»äºç¾å¹´æ¥ä¸­å½å±äº§åæ¨è¿é©¬åæä¸»ä¹ä¸­å½åæ¶ä»£åçéå¤§æå°±ï¼ééäºé©¬åæä¸»ä¹ä¸­å½åæ¶ä»£åçéå¤§åå²æï¿½ï¿½ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "åéé¢",
    "question": "( )æç¡®æâä¸æ­è°±åé©¬åæä¸»ä¹ä¸­å½åæ¶ä»£åæ°ç¯ç« âä½ä¸ºå½ä»£ä¸­å½å±äº§åäººçåºä¸¥åå²è´£ä»»ï¼å¹¶æåºäºç»§ç»­æ¨è¿é©¬åæä¸»ä¹ä¸­å½åæ¶ä»£åçæ°è¦æ±ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "åéé¢",
    "question": "æé©¬åæä¸»ä¹åºæ¬åçåä¸­å½å·ä½å®éç¸ç»åãåä¸­åä¼ç§ä¼ ç»æåç¸ç»åï¼ä¹å°±æ¯å¦ä½å®ç°é©¬åæä¸»ä¹( )çé®é¢ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "åéé¢",
    "question": "( )æ¯é©¬åæä¸»ä¹ä¸­å½åæ¶ä»£åçç¬¬ä¸æ¬¡åå²æ§é£è·ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "åéé¢",
    "question": "é©¬åæä¸»ä¹ä¸­å½åæ¶ä»£åççè®ºæææ¯ä¸èç¸æ¿å( )çå³ç³»ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "åéé¢",
    "question": "æ­£æ¯ç±äºä¸­å½å±äº§ååæ( )çææ³è·¯çº¿ï¼æè½å¤å¨å®è·µä¸­å¼åä¸­å½ç¹è²ç¤¾ä¼ä¸»ä¹éè·¯ï¼å½¢æä¸­å½ç¹è²ç¤¾ä¼ä¸»ä¹çè®ºä½ç³»ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "åéé¢",
    "question": "( )æ¯ä¸­å½ç¹è²ç¤¾ä¼ä¸»ä¹çè®ºä½ç³»çå¼ç¯ä¹ä½ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "answer": 1,
    "options": [
      "ç¤¾ä¼ä¸»ä¹ç°ä»£åå»ºè®¾æ°æ¶æ",
      "æ¹é©å¼æ¾åç¤¾ä¼ä¸»ä¹ç°ä»£åå»ºè®¾æ°æ¶æ",
      "æ¹é©å¼æ¾",
      "ç¤¾ä¼ä¸»ä¹å»ºè®¾æ¶æ"
    ],
    "subject": "æ¯æ¦",
    "category": "åéé¢",
    "question": "å¨( )ï¼ä¸­å½å±äº§ååæä»¥çè®ºåæ°å¼é¢äºä¸åå±ï¼ä»æ°çå®è·µåæ¶ä»£ç¹å¾åºååæååå±é©¬åæä¸»ä¹ï¼ç§å­¦åç­äºå»ºè®¾ä¸­å½ç¹è²ç¤¾ä¼ä¸»ä¹çåå±éè·¯ãåå±é¶æ®µãï¿½ï¿½ï¿½æ¬ä»»å¡ãåå±å¨åãåå±æç¥ï¿½ï¿½ä¸ç³»ååºæ¬é®é¢ï¼å½¢æä¸­å½ç¹è²ç¤¾ä¼ä¸»ä¹çè®ºä½ç³»ï¼å®ç°äºé©¬åæä¸»ä¹ä¸­å½åæ¶ä»£åæ°çé£è·ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "åéé¢",
    "question": "ç¤¾ä¼ä¸»ä¹æ°ä¸»æ¿æ²»çæ¬è´¨è¦æ±æ¯( )ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "åéé¢",
    "question": "å®è·µè¯æï¼ä¸­å½å±äº§åä¸ºä»ä¹è½ï¼ä¸­å½ç¹è²ç¤¾ä¼ä¸»ä¹ä¸ºä»ä¹å¥½ï¼å½æ ¹å°åºæ¯ä¸­å½åæ¶ä»£åç( )ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "åéé¢",
    "question": "ä¸­å½ç¹è²ç¤¾ä¼ä¸»ä¹çè®ºä½ç³»å§ç»åæå°( )ä½ä¸ºæ ¹æ¬å·¥ä½è·¯çº¿ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "answer": 2,
    "options": [
      "1927å¹´ä»¥åä¸­å½å±äº§åç¬ç«æè´èµ·é¢å¯¼ä¸­å½é©å½çéä»»",
      "1919å¹´ä»¥åä¸­å½é©å½è¿å¥æ°æ°ä¸»ä¸»ä¹é©å½æ¶æ",
      "19ä¸çºªæ«20ä¸çºªåï¼ä¸çè¿å¥å¸å½ä¸»ä¹åæ äº§é¶çº§é©å½æ¶ä»£",
      "1840å¹´ä»¥åä¸­å½æä¸ºä¸ä¸ªåæ®æ°å°ï¿½ï¿½ï¿½å°å»ºç¤¾ä¼"
    ],
    "subject": "æ¯æ¦",
    "category": "åéé¢",
    "question": "æ¯æ³½ä¸ææ³å½¢æçæ¶ä»£æ¡ä»¶æ¯( )ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "åéé¢",
    "question": "åç( )æåºäºâä¸­å½ç¹è²ç¤¾ä¼ä¸»ä¹çè®ºä½ç³»âçç§å­¦æ¦å¿µã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "åéé¢",
    "question": "æ¯æ³½ä¸åé æ§å°çè®ºä¸å®è·µçç¸ç»åãèªææ¹è¯ã( )çä¸­å½å±äº§åä¸å¤§å·¥ä½ä½é£ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
    ...
    "answer": 0,
    "options": [
      "ãä¸­å½å±äº§åä¸­å¤®å§åä¼å³äºå»ºå½ä»¥æ¥åçè¥å¹²åå²é®é¢çå³è®®ã",
      "ãå³äºè¥å¹²åå²é®é¢çå³è®®ã",
      "ãè§£æ¾ææ³ï¼å®äºæ±æ¯ï¼å¢ç»ä¸è´ååçã",
      "ãä¸­å±ä¸­å¤®å³äºåçç¾å¹´å¥æéå¤§æå°±ååå²ç»éªçå³è®®ã"
    ],
    "subject": "æ¯æ¦",
    "category": "åéé¢",
    "question": "ä¸­å±åä¸å±ä¸ä¸­å¨ä¼ä»¥åï¼å¯¹æ¯æ³½ä¸åæ¯æ³½ä¸ææ³çåå²å°ä½ä½åºç§å­¦çãå®äºæ±æ¯çè¯ä»·çåå²æç®æ¯( )ã",
    "difficulty": 1,
    "explanation": ""
  },
  {
  ...
  },
  {
    ...
    "subject": "æ¯æ¦",
    "category": "ç¤¾ä¼ä¸»ä¹å»ºè®¾éè·¯åæ­¥æ¢ç´¢",
